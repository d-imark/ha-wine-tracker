...
#   curl -fsSL https://raw.githubusercontent.com/d-imark/ha-wine-tracker/main/scripts/update-ha-dev.sh | bash
#
# Workflow:
...
REPO_URL="https://github.com/d-imark/ha-wine-tracker.git"
